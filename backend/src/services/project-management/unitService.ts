 ...
 * 
 * @deprecated This file is deprecated. Use the new modular units module:
 * 
 * import { 
 *   unitsFacade,
 *   unitCrudService,
 ...
 * - UnitCrudService: Create, read, update, delete operations
 * - UnitSalesService: Reservation, contract, sale, handover lifecycle
 * - UnitUpgradeService: Buildertrend-style selections/upgrades
 * - UnitStatsService: Statistics and payment tracking
 * 
