-- Migration: 129_seed_lease_templates_all_orgs.sql
-- Description: Ensure all organizations have a default lease template
-- This fixes the issue where only the first org got a template from migration 121

-- ============================================
-- SEED DEFAULT TEMPLATE FOR ALL ORGANIZATIONS
-- ============================================

-- Insert default residential template for any organization that doesn't have one
INSERT INTO lease_templates (id, organization_id, name, description, content, variables, category, is_default, is_active, version, created_at, updated_at)
SELECT 
    gen_random_uuid(),
    o.id,
...
-- COMMENTS
-- ============================================
COMMENT ON TABLE lease_templates IS 'Ensures all organizations have access to lease templates';
