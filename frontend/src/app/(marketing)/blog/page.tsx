    ...
    return (
        <main className="pt-32 pb-24 bg-background">
            ...
            {loading ? (
                <section className="pb-16">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="bg-card border border-border rounded-lg h-72 animate-pulse" />
                    </div>
                </section>
            ) : posts.length === 0 ? (
                <section className="pb-16">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="text-center py-20 border border-border rounded-lg bg-card">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-2">Articles coming soon</h3>
                                        ...
                                        <div className="p-8 lg:p-12 flex flex-col justify-center">
                                            <div className="flex items-center gap-3 mb-4">
                                                ...
                                                {featured.reading_time_minutes > 0 && (
                                                    <span className="text-sm text-muted-foreground">{featured.reading_time_minutes} min read</span>
                                                )}
                                            </div>
                                            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 group-hover:text-primary transition-colors">
                                                {featured.title}
                                            </h2>
                                            {featured.excerpt && <p className="text-muted-foreground text-lg mb-6">{featured.excerpt}</p>}
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
                            <input
                                ...
                                className="flex-1 px-6 py-4 bg-card border border-border text-foreground rounded focus:outline-none focus:border-primary transition-colors"
                            />
                            <motion.button
