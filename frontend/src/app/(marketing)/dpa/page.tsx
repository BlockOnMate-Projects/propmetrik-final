        ...
        <main className="pt-32 pb-24 bg-zinc-950 text-white">
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                ...
                >
                    ...
                    <p className="text-zinc-400 mb-4">For Enterprise Customers</p>
                    ...
                    <div className="prose prose-invert prose-lg max-w-none">
                        ...
                        <section className="mb-12">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3 mt-6">3.2 Types of Personal Data</h3>
                            <ul className="list-disc list-inside text-zinc-300 space-y-2 ml-4">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3 mt-6">3.3 Categories of Data Subjects</h3>
                            <ul className="list-disc list-inside text-zinc-300 space-y-2 ml-4">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3 mt-6">3.4 Duration</h3>
                        ...
                        <section className="mb-12">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3 mt-6">5.1 Technical Measures</h3>
                            <ul className="list-disc list-inside text-zinc-300 space-y-2 ml-4">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3 mt-6">5.2 Organizational Measures</h3>
                            <ul className="list-disc list-inside text-zinc-300 space-y-2 ml-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-white mb-4">9. Audit Rights</h2>
                            <p className="text-zinc-300 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-white mb-4">12. Duration and Termination</h2>
                            <p className="text-zinc-300">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-white mb-4">13. Contact for DPA Matters</h2>
                            <p className="text-zinc-300">
