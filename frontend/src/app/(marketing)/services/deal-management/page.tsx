                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12">
                            <div className="border border-border rounded-lg px-4 py-3 text-sm font-medium text-muted-foreground text-center">CRM & pipelines</div>
                            <div className="border border-border rounded-lg px-4 py-3 text-sm font-medium text-muted-foreground text-center">Auto-generated agreements</div>
                            <div className="border border-border rounded-lg px-4 py-3 text-sm font-medium text-muted-foreground text-center">E-signatures</div>
                            <div className="border border-border rounded-lg px-4 py-3 text-sm font-medium text-muted-foreground text-center">Commission tracking</div>
                        </div>
