...
export default function InsightsPolicyPapersPage() {
  ...
  useEffect(() => {
    publicationsApi
      .getPublished({ product: 'policy_paper', limit: 60 })
      ...
      <section className="pb-10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            <div className="text-sm font-bold text-primary uppercase tracking-[0.2em] mb-4">Government &amp; Regulatory</div>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-5">Policy Papers</h1>
            <p className="text-muted-foreground text-lg">
              Government and regulatory-focused analysis produced for policymakers, Bank of Ghana,
              multilaterals, World Bank, and embassies.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-10">
        <div className="container mx-auto px-4 md:px-6">
          <input
            ...
            placeholder="Search policy papers..."
      ...
      <section>
        <div className="container mx-auto px-4 md:px-6">
          {loading ? (
            ...
            <div className="text-center py-16 text-muted-foreground">No policy papers found.</div>
          ) : (
            <div className="space-y-4">
              {filtered.map((item) => (
