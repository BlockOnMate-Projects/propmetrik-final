...
const TABS = [
  ...
  { key: 'video', label: 'Video Commentary' },
] as const;
...
const ALLOWED = new Set(['podcast', 'webinar', 'video']);
...
export default function InsightsPodcastsVideoPage() {
  ...
  useEffect(() => {
    publicationsApi
      .getPublished({ product: 'podcast', limit: 60 })
      ...
      <section className="pb-10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-5">Podcasts &amp; Video</h1>
      ...
      <section className="pb-10">
        <div className="container mx-auto px-4 md:px-6">
          <input
            ...
            placeholder="Search podcasts & video..."
      ...
      <section>
        <div className="container mx-auto px-4 md:px-6">
          {loading ? (
            ...
            <div className="text-center py-16 text-muted-foreground">No podcasts or videos found.</div>
          ) : (
            <div className="space-y-4">
              {filtered.map((item) => (
