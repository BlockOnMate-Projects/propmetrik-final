      ...
      <section className="pb-10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-5">In the Media</h1>
      ...
      <section>
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-10 text-center">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Media coverage coming soon</h3>
