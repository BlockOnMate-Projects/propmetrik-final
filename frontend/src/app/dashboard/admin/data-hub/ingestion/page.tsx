...
export default function TierIngestionPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 pb-10">
      ...
      <div className="mb-8 border-t border-zinc-900 pt-8">
        <TerminalPanel title="Data Ingestion Pipeline">
          <div className="flex items-center justify-between gap-4 overflow-x-auto py-4">
            <div className="flex flex-col items-center gap-2 min-w-[120px]">
              ...
              <span className="font-mono text-xs text-white">SOURCES</span>
              <span className="font-mono text-[9px] text-zinc-600">5 TIERS</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 min-w-[120px]">
              ...
              <span className="font-mono text-xs text-white">EXTRACT</span>
              <span className="font-mono text-[9px] text-zinc-600">API, SFTP, PDF</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 min-w-[120px]">
              ...
              <span className="font-mono text-xs text-white">TRANSFORM</span>
              <span className="font-mono text-[9px] text-zinc-600">PDF PARSE, CLEAN</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 min-w-[120px]">
              ...
              <span className="font-mono text-xs text-white">LOAD</span>
              <span className="font-mono text-[9px] text-zinc-600">PROPERTIES DB</span>
            </div>
          </div>
        </TerminalPanel>
      </div>
