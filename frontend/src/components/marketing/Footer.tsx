                    ...
                    <div className="lg:col-span-2 min-w-0">
                        ...
                        <div className="flex gap-4">
                            {['LinkedIn', 'Twitter', 'Facebook'].map((social) => (
                                <div key={social} className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-amber-600 hover:text-foreground transition-colors cursor-pointer">
