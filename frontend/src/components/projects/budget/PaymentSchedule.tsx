...
const STATUS_CONFIG: Record<PaymentMilestone['status'], { 
  ...
  partially_paid: { label: 'Partial', color: 'bg-amber-100 text-amber-800', icon: DollarSign },
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h4 className="font-medium line-clamp-1">{milestone.name}</h4>
              {phase && (
  ...
  return (
    <SheetContent className="w-full sm:max-w-xl overflow-y-auto">
      ...
      <div className="mt-6 space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h4 className="font-medium">Linked Invoices</h4>
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <Badge
                      variant="outline"
                      className={cn(
                        invoice.status === 'paid' && 'text-green-600 border-green-300',
                        invoice.status === 'pending' && 'text-amber-600 border-amber-300'
                      )}
                    >
      ...
      {filteredMilestones.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="mt-4 font-medium">No Payment Milestones</h3>
            <p className="text-sm text-muted-foreground">
