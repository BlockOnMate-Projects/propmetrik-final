            ...
            <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                ...
                >
                    ...
                    <div className="prose prose-invert prose-lg max-w-none">
                        ...
                        <section className="mb-12">
                            ...
                            <div className="space-y-6 mt-6">
                                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-3">Essential Cookies (Required)</h3>
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-3">Functional Cookies (Optional)</h3>
                                    <p className="text-zinc-300 mb-4">
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-3">Analytics Cookies (Optional)</h3>
                                    <p className="text-zinc-300 mb-4">
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-3">Marketing Cookies (Optional)</h3>
                                    <p className="text-zinc-300 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-white mb-4">3. How to Control Cookies</h2>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white mb-2">Browser Instructions</h3>
                                    <ul className="list-disc list-inside text-zinc-300 space-y-2">
