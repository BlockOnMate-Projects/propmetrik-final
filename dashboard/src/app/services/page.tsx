    ...
    return (
        <main className="pt-32 pb-24">
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <div className="inline-block px-3 py-1 mb-6 border border-primary/20 text-primary rounded-full text-xs font-bold tracking-widest uppercase bg-primary/5">
                        Our Capabilities
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8">
                        Solutions for the <br />
                        Modern <span className="text-primary">Professional</span>
                    </h1>
                </motion.div>
