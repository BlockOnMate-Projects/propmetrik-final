                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            <Link href={feature.href} className="block h-full">
                                ...
                                <h3 className="text-3xl font-bold mb-6 mt-10 tracking-tight group-hover:text-primary transition-colors duration-300">
                                    {feature.title}
                                </h3>
                                <p className="text-zinc-600 text-lg mb-8 leading-relaxed">
                                    {feature.description}
                                </p>
                                <span className="text-sm font-bold uppercase tracking-widest border-b-2 border-transparent group-hover:border-primary pb-1 inline-block transition-all duration-300 cursor-pointer">
                                    {feature.link}
                                </span>
                            </Link>
                        </motion.div>
